...
import uuid
import MotifFinderGibbs.Utils.MotifSetUtil as MSU
import MotifFinderGibbs.Utils.GibbsUtil as GU
from MotifFinderGibbs.Utils.makeReportFromMotifSet import buildReportFromMotifSet
...
class MotifFinderGibbs:
    ...
    def find_motifs(self, ctx, params):
        ...
        parsed = ['gibbs.html','promoters.html']
        indexHtmlStr = '<html>'
