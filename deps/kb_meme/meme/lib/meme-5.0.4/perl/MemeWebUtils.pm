...
unless ($@) {
  Log::Log4perl::init('/home/manish/meme/share/meme-5.0.4/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/manish/meme/var/meme-5.0.4/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/manish/meme/share/meme-5.0.4/job_status.tmpl');
